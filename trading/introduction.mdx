---
title: 'Complete Guide to Stock Market Investing'
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="group bg-gray-50">
    ...
    <div className="bg-white/70 dark:bg-slate-800/70 p-4 rounded-lg mb-4 border border-gray-100 dark:border-gray-800">
  ...
  <div className="group bg-gray-50">
    ...
    <div className="grid grid-cols-2 gap-3 mb-4">
      <div className="bg-gray-100 dark:bg-gray-900/50 p-3 rounded-lg text-center border border-gray-200 dark:border-gray-800">
...
<div className="my-8 p-6 bg-gradient-to-r from-red-100 via-yellow-100 to-green-100 rounded-lg">
  ...
  <div className="flex justify-between items-end h-32">
    <div className="text-center">
      <div className="bg-gray-500 h-8 w-16 mb-2 rounded"></div>
      <div className="text-xs font-semibold">Savings<br/>1-2%</div>
    </div>
    <div className="text-center">
      <div className="bg-gray-500 h-16 w-16 mb-2 rounded"></div>
      <div className="text-xs font-semibold">Bonds<br/>3-5%</div>
    </div>
    <div className="text-center">
      <div className="bg-gray-500 h-20 w-16 mb-2 rounded"></div>
      <div className="text-xs font-semibold">Div. Stocks<br/>6-8%</div>
    </div>
    <div className="text-center">
      <div className="bg-gray-500 h-24 w-16 mb-2 rounded"></div>
      <div className="text-xs font-semibold">Growth Stocks<br/>8-12%</div>
    </div>
    <div className="text-center">
      <div className="bg-gray-500 h-32 w-16 mb-2 rounded"></div>
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-8">
  <div className="group bg-gray-50">
    <div className="w-12 h-12 bg-gray-500 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
