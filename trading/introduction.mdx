...
<Card title="What You'll Learn" icon="target" color="#6b7280">
  **Comprehensive Trading Education**: Master fundamental and technical analysis, risk management, portfolio construction, and market psychology for both US and Vietnam equity markets.
</Card>

## Global Market Overview

Understanding the scale and characteristics of major financial markets is essential for informed investment decisions. Each market has unique features, regulations, and opportunities.

<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="bg-slate-900 p-6 rounded-xl text-white shadow-lg border border-slate-800">
    <div className="flex items-center gap-3 mb-4">
      <div className="w-8 h-8 bg-slate-700 rounded-lg flex items-center justify-center">
        <span className="text-lg"></span>
      </div>
      <h3 className="text-xl font-bold text-white">US Markets (NYSE, NASDAQ)</h3>
    </div>
    <div className="space-y-3">
      <div className="flex justify-between items-center bg-slate-800/50 p-3 rounded-lg border border-slate-700">
        ...
        <span className="font-bold text-lg text-white">$45+ Trillion</span>
      </div>
      <div className="flex justify-between items-center bg-slate-800/50 p-3 rounded-lg border border-slate-700">
        <span className="text-slate-300">Daily Volume</span>
        <span className="font-bold text-lg text-white">$200+ Billion</span>
      </div>
      <div className="flex justify-between items-center bg-slate-800/50 p-3 rounded-lg border border-slate-700">
