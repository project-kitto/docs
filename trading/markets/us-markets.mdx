...
<div className="flex items-center gap-2 mb-      <Card title="D      <Card title="Interest Rate Sensitive" color="#6b7280">fensive Sector" color="#6b7280"> text-sm text-gray-600">
