...
<Card title="🇺🇸 World's Largest Stock Market" icon="building-columns" color="#1e40af">
...
<Tabs>
  <Tab title="Technology">
    <div className="space-y-4">
      <Card title="📱 Largest Sector by Market Cap" color="#3b82f6">
  ...
  <Tab title="Healthcare">
    <div className="space-y-4">
      <Card title="🏥 Defensive Sector" color="#059669">
  ...
  <Tab title="Financial Services">
    <div className="space-y-4">
      <Card title="🏦 Interest Rate Sensitive" color="#7c3aed">
