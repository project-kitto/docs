...
<Card title="🏢 What is Fundamental Analysis?" icon="magnifying-glass" color="#059669">
...
<Tabs>
  ...
  <Tab title="Cash Flow Statement">
    <div className="space-y-4">
      ...
      <CardGroup cols={3}>
        <Card title="Operating Cash Flow" icon="gear" color="#10b981">
          Cash from core business operations

          **Key Metric**: Should be positive and growing
        </Card>

        <Card title="Investing Cash Flow" icon="trending-up" color="#3b82f6">
          Cash used for investments in assets

          **Usually Negative**: Companies investing in growth
        </Card>

        <Card title="Financing Cash Flow" icon="banknotes" color="#8b5cf6">
...
<Card title="Porter's Five Forces" icon="shield" color="#6366f1">
...
<CardGroup cols={2}>
  <Card title="Accounting Red Flags" icon="exclamation-triangle" color="#dc2626">
  ...
  <Card title="Business Red Flags" icon="building-exclamation" color="#ea580c">
  ...
  <Card title="Financial Red Flags" icon="chart-line-down" color="#dc2626">
  ...
  <Card title="Market Red Flags" icon="trending-down" color="#b91c1c">
